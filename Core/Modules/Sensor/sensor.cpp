...
void Sensor::SPItransmitAndReceive(size_t size, uint8_t *tmp)
{
    SPIclearCS();
...
void Sensor::SPItransmit(size_t size, uint8_t *data)
{
    SPIclearCS();
    HAL_SPI_Transmit(spi_h, data, size, 10);
    SPIsetCS();
}

void Sensor::SPIclearCS()
{
    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, GPIO_PIN_RESET);
}

void Sensor::SPIsetCS()
{
