...
private:
    ...
    */
    ...
    void SPItransmitAndReceive(size_t size, uint8_t *tmp);

    void SPItransmit(size_t size, uint8_t *data);
...
private:
    ...
    const os::Task measure_task{"measure", 256, os::Task::Priority::IDLE, measureTaskFunction};
