...
void Sensor::parseFirstConversionData(const std::array<uint8_t, 1 + 26>& data) {
  // BME280 documentation page 24 table 16
  tempConvData_.digT1 = bitwise::concat2Bytes(data[2], data[1]);
  tempConvData_.digT2 = bitwise::concat2Bytes(data[4], data[3]);
  tempConvData_.digT3 = bitwise::concat2Bytes(data[6], data[5]);

  pressConvData_.digP1 = bitwise::concat2Bytes(data[8], data[7]);
  pressConvData_.digP2 = bitwise::concat2Bytes(data[10], data[9]);
  pressConvData_.digP3 = bitwise::concat2Bytes(data[12], data[11]);
  pressConvData_.digP4 = bitwise::concat2Bytes(data[14], data[13]);
  pressConvData_.digP5 = bitwise::concat2Bytes(data[16], data[15]);
  pressConvData_.digP6 = bitwise::concat2Bytes(data[18], data[17]);
  pressConvData_.digP7 = bitwise::concat2Bytes(data[20], data[19]);
  pressConvData_.digP8 = bitwise::concat2Bytes(data[22], data[21]);
  pressConvData_.digP9 = bitwise::concat2Bytes(data[24], data[23]);
