...
Rtc::Rtc(const mcuBoard::I2CBus& i2c, uint8_t address) : i2c_(i2c), slaveAddress_(address) {}
...
void Rtc::readTimeAndDate(Buffer& buffer) {
    if (i2c_.memoryRead<0x00>(slaveAddress_, buffer.array) == mcuBoard::BusResult::Ok) {
